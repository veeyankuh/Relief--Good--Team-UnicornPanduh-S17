...
<html>
    ...
    <body>
        <div class="container-fluid " style="background-color: #77bac8; height: 100px">
            <img src="img/RG1.png" height="15%" style="position: absolute"/>
            <div class="pull-right" style="margin-top: 30px;">
                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    Log In <span class="caret"></span>
                </button>
                <ul class="dropdown-menu" role="menu">
                    <li><label class="col-md-4">User: </label><div class="col-md-8"><input type="text" class="form-control" /></div></li>
                    <li><a href="#">Another action</a></li>
                    <li><a href="#">Something else here</a></li>
                    <li class="divider"></li>
                    <li><a href="#">Separated link</a></li>
                </ul>
                &nbsp;<button class="btn btn-primary form-inline">Sign Up</button>
            </div>
        </div>
        <div id="wrapper">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-9" style="padding-right: 0px; padding-left: 0px">
                                        <input class="form-control" placeholder="Where are you?" id="searchField" name="searchField"/>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>De La Salle University(COSCA)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                The Holy Spirit
                                                4321 St. Quirino Avenue, Manila, Philippines
                                            </td>
                                            <td>
                                                0
                                            </td>
        ...
        <div class="container-fluid ">
            <div class="row">
                <div class="col-lg-2 col-md-3 col-xs-3 portfolio" id="menu1"><center>

                        <br /><br /><a href="#WhatWebsite">What is this website for?</a></center>
                </div>
                <div class="col-lg-3 col-md-3 col-xs-3 portfolio" id="menu2"><center>
                        <br /><br /><a href="#VolunteerImportance">Your importance as being a Volunteer</a></center>
                </div>
                <div class="col-lg-2 col-md-3 col-xs-3 portfolio" id="menu3"><center>
                        <br /><br /><a href="#Organizations">Involved Organizations</a></center>
                </div>
                <div class="col-lg-3 col-md-3 col-xs-3 portfolio" id="menu4"><center>
                        <br /><br /><a href="#TheHelp">What this website can do for everyone!</a></center>
                </div>
                <div class="col-lg-2 col-md-3 col-xs-3 portfolio" id="menu5"><center>
                        <br /><br /><a href="#TheDevelopers">The developers</a></center>
                </div>
            </div>
            <div class="navbar" style="margin-bottom: 0px">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#WhatWebsite">What is this website for?</a></li>
                    <li><a href="#VolunteerImportance">Your importance as being a Volunteer</a></li>
                    <li><a href="#Organizations">Involved Organizations</a></li>
                    <li><a href="#TheHelp">What this website can do for everyone!</a></li>
                    <li><a href="#TheDevelopers">The developers</a></li>

                </ul>
            </div><!-- /.navbar-collapse -->
        </div>
        <div class="section1" id="WhatWebsite"><h1>About ReliefGood</h1>
        ...
        <div class="section2" id="VolunteerImportance"><h1>Why be a volunteer?</h1>
        ...
        <div class="section3" id="Organizations"><h1>Our partners</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="tile" style="text-align: left;">
                            ...
                            <h3>Here's a list of the orgranization whom are willing to help</h3>
                            <p>
        ...
        <div class="section4" id="TheDevelopers"><h1>The Creators</h1>
